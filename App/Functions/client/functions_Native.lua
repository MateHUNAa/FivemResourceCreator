...
Functions = {
     ...
     unloadModel = (function(model)
          print("^2Removing Model^7: '^6" .. model .. "^7'")
     ...
     unloadAnimDict = (function(dict)
          ...
          print("^2Removing Anim Dictionary^7: '^6" .. dict .. "^7'")
          RemoveAnimDict(dict)
     end),
     ---@param dict string
     loadPtfxDict = (function(dict)
          if not HasNamedPtfxAssetLoaded(dict) then
               print("^2Loading Ptfx Dictionary^7: '^6" .. dict .. "^7'")
     ...
     unloadPtfxDict = (function(dict)
          print("^2Removing Ptfx Dictionary^7: '^6" .. dict .. "^7'")
     ...
     makeBlip = (function(data)
          ...
          -- print("^6Blip ^2created for location^7: '^6" .. data.name .. "^7'")
          return blip
     end),
     ...
     makePed = (function(model, data, options)
          ...
          print(("^6Ped  ^2created for location^7: '^6%s^7'"):format(model))
     end),
     ---@param entity number EntityId
     destoryProp = (function(entity)
          print("^2Destroying Prop^7: '^6" .. entity .. "^7'")
     ...
     loadDrillSound = (function()
          print(("^2Loading Drill Sound Banks^7"))
     ...
     unloadDrillSound = (function()
          print(("^2Removeing Drill Sounds Banks^7"))
     ...
     lookAtMe = (function(entity)
          if DoesEntityExist(entity) then
               if not IsPedHeadingTowardsPosition(entity, GetEntityCoords(PlayerPedId()), 30.0) then
                    ...
                    print("^2Turning Player to^7: '^6" .. entity .. "^7'")
                    Wait(1500)
               end
          end
     end),
     ...
     lookEnt = (function(entity)
          if type(entity) == "vec3" then
               if not IsPedHeadingTowardsPosition(PlayerPedId(), entity, 10.0) then
                    ...
                    print("^2Turning Player to^7: '^6" .. json.encode(entity) .. "^7'")
                    Wait(1500)
               end
          else
               if DoesEntityExist(entity) then
     ...
     toggleItem = (function(give, item, amount)
            ...
            print("mCore is not running Toggle Item is not initialized in this context !")
          end
     end),
     ---@param items string
     ---@param amount number
     HasItem = (function(items, amount)
          ...
          if count >= amount then
               print(("^3HasItem^7: ^5FOUND^7 ^3     %s ^7/^3 %s %s^7"):format(count, amount, items))
               return true
          else
               print(("^3HasItem^7: ^1NOT FOUND ^2 %s ^7"):format(tostring(items)))
               return false
          end
     end),
